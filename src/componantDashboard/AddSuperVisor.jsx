  ...
  return (
    <div className={styles.AddSuperVisor}>
      ...
      <div className={styles.btnbottom}>
        <button className={ `add` } style={ { color: 'white', backgroundColor:"green"} }>اضافة</button>
        <button className={`add`} style={{border:"1px solid red",color:'red'}} onClick={()=>navigate(-1)}>الغاء</button>
      </div>
    </div>
  );
}
